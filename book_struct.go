...
// 02 ： Short description【内容紹介 取次広報誌用、内容紹介 図書館選書用】
// 03 ： Description　　  【内容紹介 オンライン書店用】
// 23 ： JBPA description 【内容紹介 これから出る本用】
//20:Keyword
const (
	textTypeBrief       = "02"
	textTypeDescription = "03"
	textTypeToc         = "04"
	textJBPADescription = "23"
